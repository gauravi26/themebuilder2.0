...
<div id="BoxModel" class="tabcontent">
  <table>
    ...
    <tr>
      <td>Margin Top:</td>
      <td><?php echo $theme->margin_top; ?></td>
    </tr>
    <tr>
      <td>Margin Right:</td>
      <td><?php echo $theme->margin_right; ?></td>
    </tr>
    <tr>
      <td>Margin Bottom:</td>
      <td><?php echo $theme->margin_bottom; ?></td>
    </tr>
    <tr>
      <td>Margin Left:</td>
      <td><?php echo $theme->margin_left; ?></td>
    </tr>
    <tr>
      <td>Padding Top:</td>
      <td><?php echo $theme->padding_top; ?></td>
    </tr>
    <tr>
      <td>Padding Right:</td>
      <td><?php echo $theme->padding_right; ?></td>
    </tr>
    <tr>
      <td>Padding Bottom:</td>
      <td><?php echo $theme->padding_bottom; ?></td>
    </tr>
    <tr>
      <td>Padding Left:</td>
      <td><?php echo $theme->padding_left; ?></td>
    </tr>
  </table>
</div>
...
<div id="Text" class="tabcontent">
  <table>
    ...
    <tr>
      ...
      <td><?php echo $theme->letter_spacing; ?></td>
    </tr>
    <tr>
      <td>Word Spacing:</td>
      <td><?php echo $theme->word_spacing; ?></td>
    </tr>
...
<div id="Link" class="tabcontent">
  ...
  <tr>
    ...
    <td><?php echo $theme->link_visited_color; ?></td>
  </tr>
  <tr>
    <td>Hover Link Color:</td>
    <td><?php echo $theme->link_hover_color; ?></td>
  </tr>
