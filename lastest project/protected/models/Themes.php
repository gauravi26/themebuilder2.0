 ...
 * @property string $link_visited_color
...
class Themes extends CActiveRecord
{
	 ...
	 */
        public $current_tab; // Add this line
	...
	public function attributeLabels()
	{
		return array(
			...
			'link_visited_color' => 'Link Visited Color',
	...
	public function search()
	{
		...
		$criteria->compare('link_hover_color',$this->link_hover_color,true);
		$criteria->compare('link_visited_color',$this->link_visited_color,true);
