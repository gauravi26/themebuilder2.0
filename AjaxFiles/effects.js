var effectsConfig = {
    ...
    "slide-in": {
        ...
        "js": "document.getElementById('btn').addEventListener('click', function () { document.getElementById('btn').classList.add('slide-in'); });"
    },
    "ripple": {
        ...
        "js": "document.getElementById('btn').addEventListener('click', function () { this.classList.add('ripple-button'); });"
    },
    "toggle": {
        ...
        "js": "document.getElementById('btn').addEventListener('click', function () { this.classList.toggle('active'); });"
    }
}
